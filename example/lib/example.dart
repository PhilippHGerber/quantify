// For readability in this examples:
...
void main() {
  ...
  // Format
  const noFraction = QuantityFormat(fractionDigits: 0);
  ...
  print('One 18-inch pizza: ${pizza18.toString(format: noFraction)}');
  print(
    'Two 12-inch pizzas: ${(pizza12 * 2).toString(format: noFraction)}',
  );

  if (pizza18 > pizza12 * 2) {
    print(
      'The 18-inch pizza is MORE pizza! '
      '(By ${(pizza18 - pizza12 * 2).toString(format: noFraction)})',
    );
  }
